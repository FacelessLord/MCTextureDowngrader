...
# Example usage
teacher = DownsampleCNN_v2()  # Your model architecture
student = DownsampleCNN_v2()
...
dataset = ImageDataset('train_index.txt', transforms.ToTensor())
check_dataset = ImageDataset('check_index.txt', transforms.ToTensor())
# Train
